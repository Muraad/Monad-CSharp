...
namespace Monads
{
    public static class Playground
    {
        public static void MaybePlayaround()
        {
            ...
            Console.WriteLine("Visits each combination of the Just 5 and the ListMonad<char> using a lambda and Console.Write inside: ");
            ...
            Console.WriteLine("The result ListMonad´s are flattned out, and only one result ListMonad<double> with all result values is returned: ");
            Console.WriteLine();
        ...
        public static void ListMonadPlayground()
        {
            ...
            var listMonadIntDoubleIMonadDoubleFunc = new ListMonad<Func<int, double, IMonad<double>>>(){intDoubleIMonadDoubleFunc1,
            ...
            listMonadInt.Com(intDoubleIMonadDoubleFunc1, listMonadDouble).Visit((x) => { Console.Write(x + ", "); });
            Console.WriteLine("\n");
            Console.ReadLine();

            Console.WriteLine("Combination with IMonad function results.");
            Console.WriteLine("List1[1,..,5], List2[1.0,..,9.0] and functions [+, -, *, /, %, [x*y*y, x*y*y*y], Nothing]");
            listMonadInt.Com(listMonadIntDoubleIMonadDoubleFunc, listMonadDouble).Visit((x) => { Console.Write(x + ", "); });
            Console.WriteLine("\n");
            Console.ReadLine();
